...
import Product1 from "./assets/clothes/clothes1.svg";
import Product2 from "./assets/clothes/clothes2.svg";
import Product3 from "./assets/clothes/clothes3.svg";
import Bagimg from "./assets/clothes/clothesimg.svg";
...
const products = [
    {
        id: 1,
        image: Product1,
        title: "Kemeja Pria UNIQLO Terbaru Kemeja Casual Trendy Kemeja Polos Lengan Panjang Kekinian",
        price: "Rp149.999",
    ...
    },
    {
        id: 2,
        image: Product2,
        title: "Oversize T-Shirt Pria Wanita Kaos Polos Pria Baju Lengan Pendek Unisex - CAMEL, XXL",
        price: "Rp1.299.000",
    ...
    },
    {
        id: 4,
        image: Product3,
        title: "IVALI Bonnie Cargo Pants - Highwaist Loose Cargo Petite - Celana Kargo Wanita - Baggy Pants",
        price: "Rp149.999",
        originalPrice: "Rp206.000",
        store: "Bostanten Official Store",
        marketplaceIcon1: Shopee,
...
const ProductGallery = () => {
    ...
    const productsPerPage = 3; // You can adjust this number based on your layout
        ...
        <div>
            ...
            <div className="container mx-auto bg-gray-200">
                <div className="w-full text-center p-[20px] flex justify-center relative bg-white shadow">
                    <div className="absolute font-bold text-2xl top-7 h-[10px] ">CLOTHES</div>
